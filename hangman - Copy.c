#
include < stdio.h > #include < stdlib.h > #include < sys / stat.h > #include < string.h > #include < ctype.h > #include "hangman.h"
...
int stringContains(const char letters_guessed[],
 const char letter) {
...
int is_word_guessed(const char secret[],
 const char letters_guessed[]) {
